                        ...
                        trendingCoins.slice(0, 3).map((coins) => (
                            <div className="flex justify-between my-5">
                                <div className="flex gap-3">
                                    {trendingCoins ? <img src={coins.item.small} className="my-auto w-7 h-7 rounded-full" /> : <Skeleton variant="circular" className="w-7 h-7" />}
                                ...
                                {trendingCoins ?
                                    <div className="bg-[#EBF9F4] flex gap-3 rounded-lg w-[84px] h-[28px] px-3">
                                        <img src="/accets/Polygon2.svg" className="w-[11px] h-2 my-auto" />
